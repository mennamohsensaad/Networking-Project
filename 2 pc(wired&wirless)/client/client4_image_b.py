  ...
  def send(self):      
        while True:
            ...
            if MESSAGE != 'exit' or MESSAGE == "0":
             ...
             #___________________________________FOR SAME PC __________________________________________________________
              socketObject.connect((socket.gethostname(), 2004))
              print("client2_Connected to localhost")
                ...
                if split2=="v":
                    with socketObject,open(""+str(n)+".MP4",'wb') as file:
                        while True:
                            ...
                            file.write(recvfile)
                    print("File has been received_client2.")
                    file.close()
                else:
